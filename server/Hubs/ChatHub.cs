...
namespace SevenStuds.Hubs
{
    public class ChatHub : Hub
    {
        ...
        public async Task UserClickedBlindIntent(string roomId, string user, string leavers) { await UserClickedActionButton(ActionEnum.BlindIntent, roomId,  user, leavers,  ""); }
        public async Task UserClickedBlindReveal(string roomId, string user, string leavers) { await UserClickedActionButton(ActionEnum.BlindReveal, roomId,  user, leavers,  ""); }
